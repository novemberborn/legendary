...
function adoptThenable(constructor, thenable, then){
...
function ResolutionPropagator(constructor, transforms){
  this._constructor = constructor || promises.Promise;
...
ResolutionPropagator.prototype.promise = function(){
  ...
  var self = this;
  var promise = this._promise = this._constructor(blessed.be);
...
ResolutionPropagator.prototype.transformSync = function(onFulfilled, onRejected){
  ...
  try{
    ...
    return then ? adoptThenable(this._constructor, result, then) : result;
  }catch(exception){
...
ResolutionPropagator.prototype._then = function(onFulfilled, onRejected){
  ...
  var propagator = new ResolutionPropagator(this._constructor, [onFulfilled, onRejected]);
...
ResolutionPropagator.prototype._delegate = function(){
  var self = this;
  var promise = this._constructor(function(resolve, reject){
...
ResolutionPropagator.prototype._resolveThenable = function(){
  var promise = adoptThenable(this._constructor, this._result, this._resultThen);
