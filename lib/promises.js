...
// promise for an array we can convert it into a
// [`Collection`](./collections.html#collection) promise like this:
...
// but without any arguments. Returns a promise that adops the original state,
// unless `onFulfilledOrRejected` throws, in which case the returned promise is
...
// * If `other` is an object, each own value that is a promise is
