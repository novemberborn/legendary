...
Series.prototype.filter = function(iterator) {
  return this.mapParallel(1, helpers.skipIfFalsy(iterator))
...
Series.prototype.filterParallel = function(maxConcurrent, iterator) {
  return this.mapParallel(maxConcurrent, helpers.skipIfFalsy(iterator))
      .then(helpers.removeSkipped);
};
...
Series.prototype.filterOut = function(iterator) {
  return this.mapParallel(1, helpers.skipIfTruthy(iterator))
      .then(helpers.removeSkipped);
};
...
Series.prototype.filterOutParallel = function(maxConcurrent, iterator) {
  return this.mapParallel(maxConcurrent, helpers.skipIfTruthy(iterator))
      .then(helpers.removeSkipped);
};
...
Series.prototype.concat = function(iterator) {
  return this.mapParallel(1, iterator).then(helpers.flatten);
};
...
Series.prototype.concatParallel = function(maxConcurrent, iterator) {
  return this.mapParallel(maxConcurrent, iterator).then(helpers.flatten);
};
...
Series.prototype.foldl = function(initialValue, iterator) {
  return guards.array(this, initialValue, function(arr) {
    return new promises.Promise(function(resolve, reject) {
      ...
      if (promises.Promise.isInstance(initialValue)) {
...
Series.prototype.detectParallel = function(maxConcurrent, iterator) {
  return this.mapParallel(maxConcurrent, helpers.shortcutDetect(iterator))
      .to(promises.Promise)
...
Series.prototype.someParallel = function(maxConcurrent, iterator) {
  return this.mapParallel(maxConcurrent, helpers.shortcutSome(iterator))
      .to(promises.Promise)
...
Series.prototype.everyParallel = function(maxConcurrent, iterator) {
  return this.mapParallel(maxConcurrent, helpers.shortcutNotEvery(iterator))
      .to(promises.Promise)
